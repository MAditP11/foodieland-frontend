...
import ImgDetailBlog from '../assets/IMG_FOODIELAND/detail_blog&article/Mask Group (2).png'
import ImgDetailBlogSec from '../assets/IMG_FOODIELAND/detail_blog&article/Rectangle 23 (1).png'
          ...
          <div class="sub-title flex flex-col gap-10 items-center">
            ...
            <div class="w-2/3">
              <p class="font-normal text-base font-inter text-black/60 leading-7">
                ...
                in ab. Corrupti cumque consectetur inventore sequi, assumenda
                animi similique, natus adipisci omnis, eos laboriosam blanditiis
                alias nulla tenetur molestiae. Placeat.
              </p>
            </div>
          ...
          <div class="content flex gap-6 px-8 w-full">
            ...
            <div class="flex flex-col w-5/6 pl-10 gap-16">
              ...
              <div class="flex flex-col gap-4 px-6">
                ...
                <p class="font-normal text-base font-inter text-black/60 leading-7">
                  ...
                  Suscipit dolor ex quia minus voluptatibus animi asperiores
                  commodi in, ipsum molestias doloremque libero laboriosam
                  dolore debitis odit accusantium eos. Ab, debitis.
                </p>
              </div>
              {/* <!-- section 2 --> */}
              <div class="flex flex-col gap-4 px-6">
              ...
              <div class="py-8 px-6 bg-[linear-gradient(to_right,var(--color-slate-100),var(--color-slate-50),var(--color-white))]">
                <p class="font-medium font-inter text-4xl italic leading-16">
                  "Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Ratione autem molestiae culpa consequatur"
                </p>
              </div>
              {/* <!-- section 5 --> */}
              <div class="flex flex-col gap-4 px-6">
            ...
            <div class="w-1/3 pr-10">
              <div class="share flex flex-col items-center gap-8">
                <div class="sub-title">
                  <h2 class="font-semibold font-inter text-sm">
                    SHARE THIS ON:
                  </h2>
                </div>
                <a
