    ...
    <div class="flex flex-col w-full pt-14 gap-16">
      <div class="content-top w-full flex items-center justify-between">
        ...
        <div class=" flex flex-col gap-12">
          <div class="title">
            <h1 class="font-semibold font-inter text-6xl">{recipe.title}</h1>
          </div>
          <div class="flex">
      ...
      <div class="flex gap-6 w-full">
        ...
        <div class="flex flex-col w-5/6 gap-20">
          <div class="ingredients flex flex-col gap-12">
            ...
            <div class="flex flex-col gap-2">
              <div class="sub-title">
                <h3 class="font-semibold font-inter text-2xl">For main dish</h3>
              </div>
            ...
            <div class="flex flex-col gap-2">
              <div class="sub-title">
                <h3 class="font-semibold font-inter text-2xl">For the sauce</h3>
              </div>
                ...
                >
                  ...
                  <div class="flex flex-col gap-6 ">
                    ...
                    <div class="font-normal text-base font-inter text-black/60 leading-7">
                      ...
                      Unde accusamus, dolor necessitatibus reprehenderit dolorem
                      libero quae? Officia alias facere qui animi accusamus.
                      Dolorum dolore repellat animi? Impedit soluta dignissimos
                      modi.
                    </div>
        ...
        <div class="w-1/3 flex flex-col p-4 gap-20">
          <div class="other-recipe flex flex-col gap-8">
            <div class="sub-title">
              <h2 class="font-semibold font-inter text-3xl">Other Recipe</h2>
            </div>
            <div class="flex flex-col gap-4">
